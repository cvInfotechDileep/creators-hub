...
import FollowingUsers from '../InnerPagesComponents/FollowingUsers'
import TopCreatorsGifters from '../InnerPagesComponents/CreatorComponents/TopCreatorsGifters'
import SimpleSlider from '../InnerPagesComponents/CreatorComponents/ExploreLivestream/SimpleSlider'
import ExploreCreators from '../InnerPagesComponents/CreatorComponents/ExploreCreators'
import Giftcarousel from '../InnerPagesComponents/CreatorComponents/ExploreCreators/Giftcarousel'
import ExploreLivestream from '../InnerPagesComponents/CreatorComponents/ExploreLivestream'
import AddPost from '../AddPost'


const CreatorsTimeline = () => {
    return (
            ...
            <Row>
                ...
                <AddPost />
                    <div className='livestreambox1'>
                        <h3 className='headingSize'>Live Streams</h3>
                    ...
                    <div className='livestreambox1'>
                        <h3 className='headingSize'>Creators Hub</h3>
                        ...
                        <div className='giftmainbox'>
                            ...
                            <div className='giftrightbox'>
                                <h3 className='headingSize'>Sony PS5 Dual Controller Marvel Spiderman 2</h3>
                        ...
                        <div className='giftmainbox_2'>
                            ...
                            <div className='giftrightbox_2'>
                                <h3 className='headingSize'>Fastest CSGO Ace Ever? [SHROUD]</h3>
                                <p className='giftdescription_2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut et massa mi. Aliquam in hendrerit urna. Pellentesque sit amet sapien fringilla.</p>
...
export default CreatorsTimeline