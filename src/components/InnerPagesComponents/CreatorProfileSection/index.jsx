...
import creatorBadge from './../../../assets/svg/creatorbadge.svg'
                ...
                <div className='usernamebox'>
                    <div className='username_balance'>
                        <div className='usernameblueicon'>
                            ...
                            <img src={creatorBadge} alt="" className='faniconcss' />
                        </div>
                        <div className='userbalancebox'>
                            <button className='btn btn-primary text-white'><span className="me-2">+</span>Follow</button>
                            <button className='btn btnbalance'>Suggest Gift <span className="ms-2"><img src={lightbulb} alt='' /></span></button>
                            <div className='backgrey'>
                                <img src={share} alt="" className='greyimghover' />
                            </div>
                        </div>
                    </div>
